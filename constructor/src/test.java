...
public class test {
    public static void main(String[] args) {
        ...
        /*account account1 = new account("Muhi muhi", "el...@outlook.com","12331231");
        account account2 = account1;
        if (account1 == account2) System.out.println("accountlar esit");*/
        
        
        new account("mmuhimu", "el...l@outlook.com","123131").bilgileriGoster();
